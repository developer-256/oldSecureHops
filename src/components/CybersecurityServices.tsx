...
import { CybersecurityServices } from "@/interface/interface";
  ...
  return (
    <div className="my-24 md:my-36  ">
      <div className="text-center">
        ...
        <p className="text-[2.7vw] sm:text-sm mt-4 text-[#333333]">
        Protecting your digital assets with cutting-edge cybersecurity solutions to {" "}
        </p>
        <p className=" text-[#333333]">ensure your online presence remains secure and resilient.</p>
      </div>
          ...
          return (
            <div key={index}>
              <div className=" md:col-span-1 md:row-span-2 ">
                ...
                <p className="mt-2 text-[4vw] sm:text-[1.8vw] text-center sm:text-start md:text-[1.1vw] text-black">{card.subtitle}</p>
